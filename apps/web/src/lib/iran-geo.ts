/**
 * Static Iran geography — WEB COPY (ONB-002), consumed by the onboarding UI.
 *
 * Byte-identical intentional duplication of
 * `apps/api/src/common/constants/iran-geo.ts` (ONB-001): hand-authored data,
 * not generated contract code, so it cannot travel through
 * `packages/shared-types` codegen. Keep the two copies identical when editing —
